...
public class Human{
    ...
    public void describePet(){
        System.out.println(name + " says: I have a " + family.getPet().getSpecies().name+ " he is " + family.getPet().getAge() + " years old, he is " + (family.getPet().getTrickLevel()>=50 ? "very sly" : "almost not sly") );
    ...
    protected void finalize() throws Throwable {
        System.out.println("Human object is deleted.");
    }
}